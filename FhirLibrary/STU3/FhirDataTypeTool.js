...
function FhirDataTypeTool() {
  ...
  this.GetNarrative = function (statusCode, divXhtml) {
    return new Narrative(statusCode, divXhtml);
  };

  function Narrative(statusCode, divXhtml) {
    var Narrative = new function () { };
    Narrative.status = FhirTool.SetFhir(statusCode);
    Narrative.div = FhirTool.SetFhir(divXhtml);
    return Narrative;
  }
