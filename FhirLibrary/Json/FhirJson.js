...
/**
 * @module
 * @description The Json2 script is a publicly available JSON parser libaray, it is used to pasre the
 * JSON response returned by ICIMS's API
*/
          ...
          for (k in value) {
            if (Object.prototype.hasOwnProperty.call(value, k)) {
              ...
              if (v) {
                ...
                //This prefix is then removed from the property name here                 
                if (k.indexOf("_xxx_") > -1) {
                  k = k.substr(5, k.length);
                }
                partial.push(quote(k) + (
                  gap
                    ? ": "
